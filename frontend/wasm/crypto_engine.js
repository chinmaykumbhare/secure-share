/* @ts-self-types="./crypto_engine.d.ts" */
 ...
 * @returns {string}
 */
export function decrypt(payload_json, password) {
    let deferred4_0;
    let deferred4_1;
    try {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('crypto_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
